  ...
  const renderItem: ListRenderItem<Partial<IncomeType>> = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        <Text style={{ color: Colors.white, fontSize:19, fontWeight:'600' }}>${amount[0]}.<Text style={{fontSize:14,fontWeight:'400'}}></Text>{amount[1]}</Text>
      </View>
    );
  };
  return (
    <View>
      <Text style={{ color: Colors.white, fontSize: 18, marginBottom: 20 }}>
